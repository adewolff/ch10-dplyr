...
mutate(pulitzer, pulitzer_prize_change = Change.in.Daily.Circulation..2004.2013-
         Change.in.Daily.Circulation..1990.2013)


# What publication gained the most pulitzer prizes from 2004-2014?
# Be sure to use the pipe operator! 
pulitzer %>% filter(Pulitzer.Prize.Winners.and.Finalists..2004.2014 == 
